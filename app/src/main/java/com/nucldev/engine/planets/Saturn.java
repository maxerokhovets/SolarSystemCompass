...
public class Saturn extends Planet implements IComputePlanetOrbitalCoordinates, IComputePlanetGeocentricCoordinates {
    private final String planetName = "Saturn";
    private final double sidericPeriod = 29.45771; // сидерический период пларнеты в земных годах
    private final double eraLongitude = 165.322242; // средняя долгота планеты в опорную эпоху
    private final double perihelionLongitude =  93.05723748; // долгота перигелия планеты
    private final double eccentricity = 0.0555481426; // эксцентриситет орбиты планеты
    private final double semimajorAxis = 9.5549091915; // большая полуось орбиты планеты
    private final double inclination = 2.48887878; // наклонение отбиты к эклиптике
    private final double ascendingNodeLongitude = 113.66550252; // долгота восходящего узла орбиты планеты
