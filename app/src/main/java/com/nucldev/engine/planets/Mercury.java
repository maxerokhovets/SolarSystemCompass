...
public class Mercury extends Planet implements IComputePlanetOrbitalCoordinates, IComputePlanetGeocentricCoordinates {
    private final String planetName = "Mercury";
    private final double sidericPeriod = 0.24085; // сидерический период пларнеты в земных годах
    private final double eraLongitude = 231.2973; // средняя долгота планеты в опорную эпоху
    private final double perihelionLongitude = 77.45611904; // долгота перигелия планеты
    private final double eccentricity = 0.2056317526; // эксцентриситет орбиты планеты
    private final double semimajorAxis = 0.3870983098; // большая полуось орбиты планеты
    private final double inclination = 7.00498625; // наклонение отбиты к эклиптике
    private final double ascendingNodeLongitude = 48.33089304; // долгота восходящего узла орбиты планеты
    ...
    private final boolean status = true; //  true у внутренних планет, false у внешних
