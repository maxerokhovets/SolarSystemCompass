...
public class Neptune extends Planet implements IComputePlanetOrbitalCoordinates, IComputePlanetGeocentricCoordinates {
    private final String planetName = "Neptune";
    private final double sidericPeriod = 164.79558; // сидерический период пларнеты в земных годах
    private final double eraLongitude = 260.3578998; // средняя долгота планеты в опорную эпоху
    private final double perihelionLongitude =  48.12027554; // долгота перигелия планеты
    private final double eccentricity = 0.009455747; // эксцентриситет орбиты планеты
    private final double semimajorAxis = 30.1103868694; // большая полуось орбиты планеты
    private final double inclination = 1.76995259; // наклонение отбиты к эклиптике
    private final double ascendingNodeLongitude =  131.78405702; // долгота восходящего узла орбиты планеты
