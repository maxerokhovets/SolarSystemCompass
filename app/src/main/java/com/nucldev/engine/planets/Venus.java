...
public class Venus extends Planet implements IComputePlanetOrbitalCoordinates, IComputePlanetGeocentricCoordinates {
    private final String planetName = "Venus";
    private final double sidericPeriod = 0.61521; // сидерический период пларнеты в земных годах
    private final double eraLongitude = 355.73352; // средняя долгота планеты в опорную эпоху
    private final double perihelionLongitude = 131.563703; // долгота перигелия планеты
    private final double eccentricity = 0.0067719164; // эксцентриситет орбиты планеты
    private final double semimajorAxis = 0.72332982; // большая полуось орбиты планеты
    private final double inclination = 3.39466189; // наклонение отбиты к эклиптике
    private final double ascendingNodeLongitude = 76.67992019; // долгота восходящего узла орбиты планеты
