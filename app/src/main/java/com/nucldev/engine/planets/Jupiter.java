...
public class Jupiter extends Planet implements IComputePlanetOrbitalCoordinates, IComputePlanetGeocentricCoordinates {
    private final String planetName = "Jupiter";
    private final double sidericPeriod = 11.8618; // сидерический период пларнеты в земных годах
    private final double eraLongitude = 146.966365; // средняя долгота планеты в опорную эпоху
    private final double perihelionLongitude = 14.33120687; // долгота перигелия планеты
    private final double eccentricity = 0.0484979255; // эксцентриситет орбиты планеты
    private final double semimajorAxis = 5.2026032092; // большая полуось орбиты планеты
    private final double inclination = 1.30326698; // наклонение отбиты к эклиптике
    private final double ascendingNodeLongitude = 100.46440702; // долгота восходящего узла орбиты планеты
