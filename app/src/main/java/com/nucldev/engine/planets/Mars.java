...
public class Mars extends Planet implements IComputePlanetOrbitalCoordinates, IComputePlanetGeocentricCoordinates {
    private final String planetName = "Mars";
    private final double sidericPeriod = 1.88089; // сидерический период пларнеты в земных годах
    private final double eraLongitude = 126.30783; // средняя долгота планеты в опорную эпоху
    private final double perihelionLongitude =  336.06023395; // долгота перигелия планеты
    private final double eccentricity = 0.0934006477; // эксцентриситет орбиты планеты
    private final double semimajorAxis = 1.5236793419; // большая полуось орбиты планеты
    private final double inclination = 1.84972648; // наклонение отбиты к эклиптике
    private final double ascendingNodeLongitude = 49.55809321; // долгота восходящего узла орбиты планеты
